...
export const MonthlyLeadVolumeSchema = z.string().min(1, "Required");
...
export const DormantLeadsSchema = z.string().min(1, "Required");
...
export const CloseRateSchema = z.string().min(1, "Required");
