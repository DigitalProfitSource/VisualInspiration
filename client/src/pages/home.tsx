...
export default function Home() {
  ...
  return (
    <Layout>
      ...
      />
      {/* Hero Section */}
      <section className="relative min-h-screen flex items-start md:items-end pt-24 md:pt-20 md:pb-28 overflow-hidden">
        ...
        <motion.div style={{ y: contentY }} className="container mx-auto px-6 relative z-10">
          ...
          >
            ...
            <motion.div variants={fadeIn} className="hidden md:flex flex-row gap-8 items-center max-w-3xl mt-10">
