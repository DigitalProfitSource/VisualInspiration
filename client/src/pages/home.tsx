      ...
      <section className="relative min-h-screen flex items-start md:items-center pt-24 md:pt-20 overflow-hidden">
        ...
        <motion.div style={{ y: contentY }} className="container mx-auto px-6 relative z-10">
          ...
          >
            ...
            <motion.p variants={fadeIn} className="hidden md:block text-lg md:text-xl text-muted-foreground mb-8 max-w-xl leading-relaxed">We architect the digital backbone that aligns your entire customer journey into one intelligent, automated flow</motion.p>
          </motion.div>
        </motion.div>
