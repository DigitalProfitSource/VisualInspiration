              ...
              <div className="grid lg:grid-cols-2 gap-10 relative z-10">
                <div>
                  ...
                  <ContactFormDialog
                    ...
                    trigger={
                      <Button 
                        data-testid="button-growth-architecture"
              ...
              <div className="grid lg:grid-cols-2 gap-10">
                <div>
                  ...
                  <ContactFormDialog
                    ...
                    trigger={
                      <Button 
                        data-testid="button-operating-system"
            ...
            <div className="p-8 rounded-2xl border border-dashed border-white/10 bg-transparent relative group hover:border-primary/20 transition-all">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div className="flex-1">
                  ...
                  <p className="text-primary text-sm mb-3 font-medium">Keep improving. Keep scaling.</p>
                  <p className="text-muted-foreground leading-relaxed max-w-2xl">
                    For businesses that want continuous system evolution. We monitor performance, optimize workflows, test new automation, refine messaging, and ensure your system adapts with your business. Includes monthly reports, ongoing consulting, and unlimited iteration support.
                  </p>
                </div>
                <div className="flex-shrink-0">
                  <ContactFormDialog
                    ...
                    trigger={
                      <Button 
                        data-testid="button-ongoing-support"
                        variant="outline"
